    ...
    for dirpath, dirnames, filenames in os.walk('public'):
        for filename in filenames:
            ...
            if len(blocks):
                ...
                script_tag = soup.new_tag("script", src="https://github.com/tutuwu2019/js-code/blob/main/decrypt.js")
